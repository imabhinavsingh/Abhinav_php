    ...
    <div class="main-card text-center" style="max-width:500px;margin:auto;">
        ...
        <div class="card-title">ABHINAV KUMAR</div>
        ...
        <div class="social-icons">
            <a href="https://www.linkedin.com/in/immabhinavsingh" target="_blank"><i class="bi bi-linkedin btn-animate"></i></a>
            <a href="https://www.instagram.com/iammabhinavsingh" target="_blank"><i class="bi bi-instagram btn-animate"></i></a>
            <a href="https://x.com/immabhinavsingh" target="_blank"><i class="bi bi-x-lg btn-animate"></i></a>
            <a href="https://github.com/imabhinavsingh" target="_blank"><i class="bi bi-github btn-animate"></i></a>
        </div>
    </div>
